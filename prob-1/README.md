...
Consider the horizontal bar shown in the figure, with length (in the appropriate units) $L=2\pi$ and cross\-sectional area $A_s =3.0$; its right end is fixed to the wall.  We place the origin of coordinates at the left end of the bar (point $O$), so that the $x$ values increase to the right. The Young’s modulus, $E$, of the material forming the bar depends on $x$ according to the formula:
